...
---- CORE NOE STUFF INCLUDE
include "LuaRules/modules/core/ext/mathExt/mathExt.lua"
include "LuaRules/Configs/noe/modules/core/mapping.lua"
include "LuaRules/Configs/noe/modules/core/groups_controller.lua"
include "LuaRules/Configs/noe/modules/core/targets_controller.lua"
include "LuaRules/Configs/noe/modules/core/teams_controller.lua"
include "LuaRules/Configs/noe/modules/core/commands.lua"
include "LuaRules/Configs/noe/modules/core/blackboard.lua"
----
...
function gadget:Initialize()
	...
	if (frameworkOFFwithoutAI and numberOfNoeAITeams == 0) then
		...
		------- IF NOE IS ON, DO: --------
		include "LuaRules/Configs/noe/side.lua"
		include "LuaRules/Configs/noe/map.lua"
		include "LuaRules/Configs/noe/diff.lua"
	    include "LuaRules/Configs/noe/groups.lua"
		include "LuaRules/Configs/noe/classes.lua"
		include "LuaRules/Configs/noe/formations.lua"
		include "LuaRules/Configs/noe/spirits.lua"
		include "LuaRules/Configs/noe/spawn.lua"
		include "LuaRules/Configs/noe/conditions.lua"
		include "LuaRules/Configs/noe/events.lua"
		include "LuaRules/Configs/noe/actions.lua"
		include "LuaRules/Configs/noe/terraform.lua"
		include "LuaRules/Configs/noe/tasks.lua" 
		include "LuaRules/Configs/noe/module_loader.lua"
		-- other rules --
		include "LuaRules/Configs/noe/rules.lua"
		...
		if (playMission) then
			...
			if (NewTerraformer) then NewTerraformer() end
			
			-- units spawn editing --
		    if (NewSpawner) then NewSpawner() end --- in mission file spawn.lua (function that can prepare some data for mission - like own mapping, positions for features etc.)			
		end
		...
		for i=1,numberOfNoeAITeams do
				...
				for j=1,numberOfGroups do
					...
					if (thisGroupDef == nil) then
    					Spring.Echo("!ERROR: This group is not defined correctly: " .. groupName .. " - check side.lua and groups.lua")
		...
		--- LuaRules/Configs/noe/classes.lua ---
		...
		--- LuaRules/Configs/noe/formations.lua ---
		--- LuaRules/Configs/noe/spirits.lua  ---
		...
		BuffersDebug(false,groupCount,groupInfo,teamInfo,sourcesList,unitTypesList)   --- in groups.lua
		-- buffers end --
		...
		Generation() -- generation of all generated formations in formations.lua
		---- formation rotation ----
        Rotation()   -- rotation of all rotating formations in formations.lua
		--- end of preparing rotations ---
		FormationsDebug(false) --- write all formations positions (in formations.lua)
		
		---- METAL MAP ---
		--- LuaRules/Configs/noe/modules/tools/mex_finder.lua ---
		----
		...
		---- BUILD MAP ---
		--- LuaRules/Configs/noe/modules/tools/build_space_finder.lua ---
		----
