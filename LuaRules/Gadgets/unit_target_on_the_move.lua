...
function gadget:GetInfo()
  return {
	...
	author	= "Google Frog, pirated for NOTA by PepeAmpere",
	date	= "06/05/2013", -- hmmm, birthday present, my precious!
...
local NO_TARGET = 0
if (Game ~= nil and ((tonumber(Engine.version) or 100) >= 99)) then
	NO_TARGET = nil
end
...
local function removeUnit(unitID)
	spSetUnitTarget(unitID, NO_TARGET) --unsets target
