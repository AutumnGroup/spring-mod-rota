...
local function UpdateGrid(g,cmds,ordertype)
	...
	for i=1,#page[curpage] do
		...
		--http://springrts.com/phpbb/viewtopic.php?f=23&t=20680&p=386749#p386749		
		icon.texturecolor = cmd.disabled and { 0.5, 0.5, 0.5, 1.0 } or { 1.0, 1.0, 1.0, 1.0 }
...
function widget:Shutdown()
	...
	UpdateGrid(buildmenu,{},1)
	UpdateGrid(ordermenu,{},2)
end
