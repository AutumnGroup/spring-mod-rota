...
local jumpDefNames  = VFS.Include"LuaRules/Configs/teleport_defs.lua"
...
local curve = {CMD_MOVE, CMD_TELEPORT}
...
local function DrawQueue(unitID)
  ...
  for i=1, #queue do
    if (queue[i].id == CMD_TELEPORT) then
...
function widget:DrawWorld()
  ...
  if (activeCommand == CMD_TELEPORT) then
