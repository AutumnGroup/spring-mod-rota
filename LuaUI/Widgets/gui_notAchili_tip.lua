...
local function UpdateResourceStack( tooltipType, unitID, ud, tooltip, fontSize )
	...
	globalItems[resource_tt_name] = StackPanel:New{
		...
		itemMargin = {5,0,0,0},
		children = {
			Image:New{file='LuaUI/Widgets/notAchili/notaUI/images/resources/metal.png',height= icon_size,width= icon_size, fontSize=ttFontSize,},
			lbl_metal2,
			Image:New{file='LuaUI/Widgets/notAchili/notaUI/images/resources/energy.png',height= icon_size,width= icon_size, fontSize=ttFontSize,},
			lbl_energy2,
		},
	}
end
...
local function MakeToolTip_UD( buildTable )
	...
	local unitStatsIconPrefix = ":a:LuaUI/Widgets/notAchili/notaUI/images/unitStats/"
	...
	local ttStructure = {
		leftBar = {
			buildPic,
			{ name = 'metalCost',  icon = 'LuaUI/Widgets/notAchili/notaUI/images/resources/metal.png',  text = metalTextColor  .. formatThousands( info.metalCost  ), },
			{ name = 'energyCost', icon = 'LuaUI/Widgets/notAchili/notaUI/images/resources/energy.png', text = energyTextColor .. formatThousands( info.energyCost ), },
			{ name = 'buildCost',  icon = 'LuaUI/Widgets/notAchili/notaUI/images/unitStats/build.png',  text = GetBuildTime( info ), },
		},
		main = {
...
local function MakeToolTip_Unit( data, tooltip )
	...
	local ttStructure = {
		leftBar = {
			...
			--{ name= 'cost', icon = LuaUI/Widgets/notAchili/notaUI/images/resources/metal.png', text = cyan .. numformat((tt_ud and tt_ud.metalCost) or '0') },
		},
		main = {
...
local function CreateHpBar( name )
	globalItems[ name ] = StackPanel:New{
		...
		children = {
			Image:New{
				file = 'LuaUI/Widgets/notAchili/notaUI/images/unitStats/health.png',
				x = 0, width = icon_size,
...
local function MakeMapDrawingToolTip()
	local ttStructure = {
		main = {
			{ name='lmb', 		icon = LUAUI_DIRNAME .. 'Widgets/notAchili/notaUI/images/drawingCursors/pencil.png', 	text = 'Left Mouse Button', },
			{ name='rmb', 		icon = LUAUI_DIRNAME .. 'Widgets/notAchili/notaUI/images/drawingCursors/eraser.png', 	text = 'Right Mouse Button', },
			{ name='mmb', 		icon = LUAUI_DIRNAME .. 'Widgets/notAchili/notaUI/images/drawingCursors/flag.png', 		text = 'Middle Mouse Button', },
			{ name='dblclick', 	icon = LUAUI_DIRNAME .. 'Widgets/notAchili/notaUI/images/drawingCursors/flagtext.png', 	text = 'Double Click', },
		},
	}
...
function widget:Initialize()
	...
	_, iconFormat = VFS.Include( LUAUI_DIRNAME .. "Widgets/notAchili/notaUI/config/tip_conf.lua" , nil, VFSMODE )
...
function widget:DrawScreen()
	...
	local filefound
	if drawing then
		filefound = glTexture( LUAUI_DIRNAME .. 'Widgets/notAchili/notaUI/images/drawingCursors/pencil.png' )
	elseif erasing then
		filefound = glTexture( LUAUI_DIRNAME .. 'Widgets/notAchili/notaUI/images/drawingCursors/eraser.png' )
	end
