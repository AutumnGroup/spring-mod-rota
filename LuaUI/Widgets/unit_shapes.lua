...
local rectangleBorderFactor = 0.2
local CAlpha = 0.5

local colorout = {   1,   1,   1,   0.4 } -- outer color
local colorin  = {   1,   1,   1,   0.5 } -- inner color
...
local function CreatePolygonCallback(points, immediate)
	...
	function callback.fading(colorin, colorout, innersize, outersize)
		local diff = ( outersize - innersize ) * rectangleBorderFactor
		local steps = {}
