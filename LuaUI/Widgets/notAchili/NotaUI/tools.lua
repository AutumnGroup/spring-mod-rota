...
local function GetUnitIconByHumanName( name )
	...
	if not VFS.FileExists( icon ) then
		icon = "LuaUI/Widgets/notAchili/notaUI/images/console/warning.png"
	end
...
local function GetSideIconByName( side )
	...
	icon = "LuaUI/Widgets/notAchili/notaUI/images/console/" .. side .. ".png"
	if not VFS.FileExists( icon ) then
		icon = "LuaUI/Widgets/notAchili/notaUI/images/console/player.png"
	end
