...
local prefix = ":n:LuaUI/Images/unitFrames/"
local ecoTex     = prefix .. "frame_eco.png"
local consTex    = prefix .. "frame_cons.png"
local unitTex    = prefix .. "frame_unit.png"
local diffTex    = prefix .. "frame_diff.png"
local frameTex   = prefix .. "frame_slate.png"
